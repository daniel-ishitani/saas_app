class ProjectsController < ApplicationController
  ...
  def users
    ...
    @other_users = @tenant.users.where(is_admin: nil) - (@project_users + [current_user])
  end
  ...
  private
    ...
    def verify_tenant
      unless params[:tenant_id] == Tenant.current_tenant_id.to_s
        redirect_to :root, flash: { error: "User doesn't have permission to access this organization."}
      end 
    end
